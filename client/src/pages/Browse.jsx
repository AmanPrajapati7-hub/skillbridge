              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div
                      className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-bold text-sm overflow-hidden cursor-pointer"
                      onClick={(e) => {
                        e.preventDefault();
                        navigate(`/profile/${gig.seller?._id}`);
                      }}
                    >
                  ...
                  <h3 className="font-semibold text-gray-800 mb-2">{gig.title}</h3>
